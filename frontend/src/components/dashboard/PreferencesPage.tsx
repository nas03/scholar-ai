...
import { User, Lock, Palette, GraduationCap, Camera, Save, Eye, EyeOff, Smartphone } from "lucide-react";
...
export function PreferencesPage() {
  ...
  // Personal Info State
  const [personalInfo, setPersonalInfo] = useState(userPreferences.personalInfo);
  ...
  const [previewImage, setPreviewImage] = useState(personalInfo.profilePicture || "");
  ...
  const handleSavePersonalInfo = () => {
    ...
    const phoneChanged = personalInfo.phoneNumber !== userPreferences.personalInfo.phoneNumber;
    
    if (phoneChanged && personalInfo.phoneNumber && personalInfo.phoneNumber.trim() !== "") {
  ...
  const handleVerifyPhone = () => {
    ...
    setTimeout(() => {
      if (phoneOTP === MOCK_PHONE_OTP) {
        ...
        setPhoneVerificationError("Invalid verification code. Please try again.");
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-6">
                <Avatar className="w-24 h-24">
                  <AvatarImage src={previewImage} alt={`${personalInfo.firstName} ${personalInfo.lastName}`} />
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select value={gpaScale} onValueChange={(value: any) => setGpaScale(value)}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="4.0">4.0 Scale (Standard US)</SelectItem>
                      <SelectItem value="5.0">5.0 Scale (Weighted)</SelectItem>
                      <SelectItem value="10.0">10.0 Scale (European)</SelectItem>
                    </SelectContent>
                  </Select>
                  <p className="text-xs text-muted-foreground">
                ...
                <Card className="p-4 bg-muted">
                  <div className="space-y-3">
                    ...
                    <div className="text-xs text-muted-foreground">
                      <p className="mb-2">Note: Changing the GPA scale will affect how your grades are displayed throughout the application.</p>
                      <p>Your existing grades will be automatically converted to the new scale.</p>
                    </div>
                  </div>
                </Card>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Choose your preferred color theme. System will use your device's theme preference.
                  </p>
                </div>
          ...
          <div className="space-y-6 py-4">
            <div className="space-y-2">
              ...
              {phoneVerificationError && (
                <p className="text-sm text-red-500 text-center mt-2">{phoneVerificationError}</p>
              )}
            </div>
            ...
            <div className="p-4 bg-muted rounded-lg">
              <p className="text-xs text-muted-foreground text-center">
                For testing purposes, use code: <span className="font-mono font-semibold">654321</span>
              </p>
            </div>
          </div>
        </DialogContent>
