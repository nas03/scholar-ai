            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                {course.gpa !== undefined && (
                  <Badge className="bg-green-500 text-base">GPA: {course.gpa.toFixed(2)}</Badge>
                )}
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl">{courseNotes.length + courseMaterials.length}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {courseMaterials.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-muted-foreground mb-6">
                  Add videos, PDFs, links, and other study materials for this course
                </p>
                <Button onClick={onAddMaterial}>
                  <Upload className="w-4 h-4 mr-2" />
          ...
          <Card className="p-6">
            ...
            {courseNotes.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-muted-foreground mb-6">
                  Create notes for this course to keep your study materials organized
                </p>
                <Button onClick={onAddNote}>
                  <Plus className="w-4 h-4 mr-2" />
