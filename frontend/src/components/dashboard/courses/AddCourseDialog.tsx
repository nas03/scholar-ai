      ...
      <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => onFormChange({ ...formData, credits: e.target.value })}
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select value={formData.semester} onValueChange={(value) => onFormChange({ ...formData, semester: value })}>
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => onFormChange({ ...formData, instructor: e.target.value })}
            />
          </div>
          ...
          <div className="space-y-2">
            <SchedulePicker
              ...
              onChange={(value) => onFormChange({ ...formData, scheduleDetails: value })}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="e.g., 3.5"
              value={formData.gpa}
              onChange={(e) => onFormChange({ ...formData, gpa: e.target.value })}
            />
          </div>
