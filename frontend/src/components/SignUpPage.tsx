...
import { GraduationCap, ArrowLeft, Check, X, AlertCircle } from "lucide-react";
...
export function SignUpPage({ onNavigate, onSignUpSuccess, initialFormData }: SignUpPageProps) {
          ...
          <Card className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                />
                {emailError && (
                  <div className={`flex items-center gap-2 text-sm ${formData.email.endsWith('.edu') ? 'text-muted-foreground' : 'text-red-500'}`}>
